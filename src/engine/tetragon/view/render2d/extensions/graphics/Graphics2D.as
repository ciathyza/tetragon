package tetragon.view.render2d.extensions.graphics
{
	...
	import tetragon.view.render2d.extensions.graphics.shaders.fragment.TextureFragmentShader2D;
	...
	public class Graphics2D
	{
		...
		private static var textureFragmentShader:TextureFragmentShader2D = new TextureFragmentShader2D();
		public static const BEZIER_ERROR:Number = 0.75;
		// private static const DEG_TO_RAD:Number = Math.PI / 180;
		
		private var _currentX:Number;
		private var _currentY:Number;
		private var _currentStroke:Stroke2D;
		private var _currentFill:Fill2D;
		private var _fillColor:uint;
		private var _fillAlpha:Number;
		private var _strokeThickness:Number;
		private var _strokeColor:uint;
		private var _strokeAlpha:Number;
		private var _strokeTexture:Texture2D;
		private var _strokeMaterial:IMaterial2D;
		private var _container:DisplayObjectContainer2D;


		public function Graphics2D(displayObjectContainer:DisplayObjectContainer2D)
		{
		...
		public function clear():void
		{
			...
			{
				var child:DisplayObject2D = _container.getChildAt(0);
				child.dispose();
		...
		public function beginBitmapFill(bitmap:BitmapData, uvMatrix:Matrix = null):void
		{
			...
			var texture:Texture2D = Texture2D.fromBitmapData(bitmap, false);
		...
		public function beginTextureFill(texture:Texture2D, uvMatrix:Matrix = null):void
		{
			_fillColor = 0xFFFFFF;
			_fillAlpha = 1;
		...
		public function beginMaterialFill(material:IMaterial2D, uvMatrix:Matrix = null):void
		{
			_fillColor = 0xFFFFFF;
			_fillAlpha = 1;
		...
		public function drawEllipse(x:Number, y:Number, width:Number, height:Number):void
		{
			...
			var cachedFill:Fill2D = _currentFill;
			if ( _currentFill )
			{
				var nGon:NGon2D = new NGon2D(width * 0.5, numSides);
				nGon.x = x;
				nGon.y = y;
		...
		public function drawRect(x:Number, y:Number, width:Number, height:Number):void
		{
			...
			if ( _currentFill )
			{
				...
				var plane:Plane2D = new Plane2D(width, height);
		...
		public function drawRoundRectComplex(x:Number, y:Number, width:Number, height:Number, topLeftRadius:Number, topRightRadius:Number, bottomLeftRadius:Number, bottomRightRadius:Number):void
		{
			...
			var storedFill:Fill2D;
			var roundedRect:RoundedRectangle2D = new RoundedRectangle2D(width, height, topLeftRadius, topRightRadius, bottomLeftRadius, bottomRightRadius);
		...
		public function lineTexture(thickness:Number = NaN, texture:Texture2D = null):void
		{
			_strokeThickness = thickness;
		...
		public function lineMaterial(thickness:Number = NaN, material:IMaterial2D = null):void
		{
			_strokeThickness = thickness;
			_strokeColor = 0xFFFFFF;
			_strokeAlpha = 1;
		...
		public function curveTo(cx:Number, cy:Number, a2x:Number, a2y:Number, error:Number = BEZIER_ERROR):void
		{
			...
			var points:Vector.<Number> = CurveUtil2D.quadraticCurve(startX, startY, cx, cy, a2x, a2y, error);
		...
		public function cubicCurveTo(c1x:Number, c1y:Number, c2x:Number, c2y:Number, a2x:Number, a2y:Number, error:Number = BEZIER_ERROR):void
		{
			...
			var points:Vector.<Number> = CurveUtil2D.cubicCurve(startX, startY, c1x, c1y, c2x, c2y, a2x, a2y, error);
