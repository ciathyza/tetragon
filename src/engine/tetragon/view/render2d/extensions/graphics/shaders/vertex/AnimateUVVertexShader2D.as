package tetragon.view.render2d.extensions.graphics.shaders.vertex
{
	...
	public class AnimateUVVertexShader2D extends AbstractShader2D
	{
		public var uSpeed:Number = 1;
		public var vSpeed:Number = 1;


		public function AnimateUVVertexShader2D(uSpeed:Number = 1, vSpeed:Number = 1)
		{
			this.uSpeed = uSpeed;
			this.vSpeed = vSpeed;
		...
		override public function setConstants(context:Context3D, firstRegister:int):void
		{
			...
			context.setProgramConstantsFromVector(Context3DProgramType.VERTEX, firstRegister,
				Vector.<Number>([uOffset, vOffset, 0, 0]));
		}
	}
}
