...
{
	public class RoundedRectangle2D extends Graphic2D
	{
		...
		public function RoundedRectangle2D(width:Number = 100, height:Number = 100,
			topLeftRadius:Number = 10, topRightRadius:Number = 10, bottomLeftRadius:Number = 10,
