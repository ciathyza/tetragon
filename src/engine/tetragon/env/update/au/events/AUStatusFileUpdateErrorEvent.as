package tetragon.env.update.au.events
{
	 ...
	 */
	public class AUStatusFileUpdateErrorEvent extends ErrorEvent
	{
		/**
		...
		public function AUStatusFileUpdateErrorEvent(type:String, bubbles:Boolean = false, cancelable:Boolean = false, text:String = "", id:int = 0)
		{
		...
		{
			return new AUStatusFileUpdateErrorEvent(type, bubbles, cancelable, text, errorID);
		}
