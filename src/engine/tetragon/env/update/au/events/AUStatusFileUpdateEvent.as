package tetragon.env.update.au.events
{
	...
	public class AUStatusFileUpdateEvent extends AUUpdateEvent
	{
		/**
		...
		public function AUStatusFileUpdateEvent(type:String, bubbles:Boolean = false, cancelable:Boolean = false, available:Boolean = false, version:String = "", path:String = "", versionLabel:String = "")
		{
		...
		{
			return new AUStatusFileUpdateEvent(type, bubbles, cancelable, available, version, path, versionLabel);
		}
