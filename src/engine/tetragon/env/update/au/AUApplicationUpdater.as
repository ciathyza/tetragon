package tetragon.env.update.au
{
	...
	import tetragon.env.update.au.ui.AUUpdateUIWrapper;
	...
	[Event(name="initialized", type="tetragon.env.update.au.events.AUUpdateEvent")]
	...
	[Event(name="fileUpdateStatus", type="tetragon.env.update.au.events.AUStatusFileUpdateEvent")]
	
	/** Dispatched when an error occured while trying to parse the AIR file from installFromAIRFile call **/
	[Event(name="fileUpdateError", type="tetragon.env.update.au.events.AUStatusFileUpdateErrorEvent")]
