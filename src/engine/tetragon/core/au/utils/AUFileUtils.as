package tetragon.core.au.utils
{
	...
	public final class AUFileUtils
	{
		...
		public static function getDocumentsStateFile():File
		{
			return new File(File.applicationStorageDirectory.nativePath
				+ "/../../" + AUVersionUtils.getApplicationID() + "_" + AUConstants.STATE_FILE);
		}
		
		
		public static function getStorageStateFile():File
		{
			return File.applicationStorageDirectory.resolvePath(AUConstants.UPDATER_FOLDER
				+ "/" + AUConstants.STATE_FILE);
		}
		...
		{
			return File.applicationStorageDirectory.resolvePath(AUConstants.UPDATER_FOLDER
				+ "/" + AUConstants.DESCRIPTOR_LOCAL_FILE);
		}
